<template>
      ...
      <Modal
        ...
        @on-ok="drawReportChart">
          <!-- 背景图 -->
          <RadioGroup v-model="imgAndChartInfo.imgSelecteToTitle" class='imgSelecteToTitle'>选择title背景图：
          ...
          <RadioGroup v-model="imgAndChartInfo.imgSelecteTochartBox" class='imgSelecteTochartBox'>选择容器背景图：
          ...
          <!-- 图形 -->
          <Tabs type="card" v-model='imgAndChartInfo.tabType'>
              <TabPane label="选择图形" name='chart'>
                <RadioGroup v-model="imgAndChartInfo.chartSelected" type='button'>
              ...
              <TabPane label="选择表格" name='table'>
                <RadioGroup v-model="imgAndChartInfo.tableSelected" type='button'>
